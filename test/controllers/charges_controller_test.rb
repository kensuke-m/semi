...
class ChargesControllerTest < ActionController::TestCase
  ...
  test "should create charge" do
    assert_difference('Charge.count') do
      post :create, charge: { capacity: @charge.capacity, staff_id: @charge.staff_id, subject_id: @charge.subject_id }
    end
  ...
  test "should update charge" do
    patch :update, id: @charge, charge: { capacity: @charge.capacity, staff_id: @charge.staff_id, subject_id: @charge.subject_id }
    assert_redirected_to charge_path(assigns(:charge))
  end
